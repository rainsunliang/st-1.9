...
struct _st_thread {
  ...
  _st_thread_t *right;	      /* -- see docs/timeout_heap.txt for details */
                              /* can use the implement of linux kernel timer to c by lgw*/
  int heap_index;
...
typedef struct _st_eventsys_ops {
  ...
  void (*pollset_del)(struct pollfd1 *, int); /* Delete descriptor set */
...
extern _st_thread_t *_st_this_thread; /*current thread by lgw*/
...
#ifdef DEBUG
#define _ST_THREADQ                     (_st_this_vp.thread_q)  /*all threads of this vp by lgw*/
#endif
...
#define _ST_VP_IDLE()                   (*_st_eventsys->dispatch)() /*call dispatch function on IDEL? by lgw*/
...
/*use ballance binary tree by lgw*/
 ...
 * Constants
 */
/*typedef unsigned long long  st_utime_t; in public.h by glw*/
#ifndef ST_UTIME_NO_TIMEOUT
#define ST_UTIME_NO_TIMEOUT ((st_utime_t) -1LL) /*not sub, it is force cast by lgw*/
#endif
